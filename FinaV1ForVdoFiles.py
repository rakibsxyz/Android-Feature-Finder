# -*- coding: utf-8 -*-
"""kmeansOnVdoFileDatawithWordFinding.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17wtTZshAswwoWvASDTf8uawV8TomjR73
"""
...
# df = pd.read_csv('/content/drive/MyDrive/sPL3/k9dataAllAttrib.csv')
df = pd.read_csv('/content/drive/MyDrive/sPL3/vdoFileTracedata/vdoFile.csv')
copyDf = df
...
totalCluster = int(input("Enter your value: "))
print(totalCluster)
...
list_A = fragmentFeatureName[1]
list_B = acvityFeatureName[1]
wordSet = set()
...
# 0 msgcompose activityListener
# 1 messagecompose messagelist
# 2 messagecompose messagelist
# 3 messagelist messagelistadapter
# 4 messagecompose messagelist
#  6 messagecompose messagelist
#  7 messagelist messagelistadapter

# methodNameList

# v2 = TfidfVectorizer(max_features=10)
# tfidf2= v2.fit_transform(methodNameList[8].values.astype('U'))
# names = v2.get_feature_names()
# print(names)
# Tried for methodnames

v2 = TfidfVectorizer(max_features=10)
tfidf2= v2.fit_transform(packageMethodNameList[1].values.astype('U'))
names = v2.get_feature_names()
print(names)
